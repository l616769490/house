...
public class OptionController {
    ...
    public Option rent(String year) {
        ...
        List<Data> legendData = showSerivce.getData("2013", "公平市场租金", 2);
        ...
        //
        //
        List<Data> lineData = showSerivce.getData("2013", "公平市场租金", 1);
        String Max = null;
        String Min = null;
        String Avg = null;
        //获取最大最小平均值
    ...
    public Option priceByBuild(String year) {
        Option option = showSerivce.select("2013", "价格统计");
        return option;
    }
    ...
    public Option roomByBuild(String year) {
        Option option = showSerivce.select("2013", "房间数统计");
        return option;
    }
