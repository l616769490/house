...
@Controller
public class DYTableController {
    TableService tableService = new TableServiceImpl();
    @ResponseBody
    @RequestMapping(value = "/units_option_table", method = RequestMethod.POST)
    ...
    @ResponseBody
    @RequestMapping(value = "/price_city_table", method = RequestMethod.POST)
