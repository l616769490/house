...
import com.tecode.house.azxl.test.GetIncome;
...
public class Test3 {
    public static void main(String[] args) {
        ...
        Map<String, Iterable<Tuple3<String, Object, Object>>> income = getIncome.getIncome("5万以下",3);
        Iterator<Tuple2<String, Iterable<Tuple3<String, Object, Object>>>> iterator = income.iterator();
