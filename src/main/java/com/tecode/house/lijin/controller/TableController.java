...
public class TableController {
    ...
    public Table basicsRoomsNumTable(@RequestBody TablePost tablePost) {
        return tableServer.getTable("基础-房间数分析", tablePost, TableController.class.getResource("/table/basics-rooms.xml").getPath());
    }
    ...
    public Table regionZinc2NumTable(@RequestBody TablePost tablePost) {
        ...
        return tableServer.getTable("按区域-家庭收入分析", tablePost, TableController.class.getResource("/table/region-zinx2.xml").getPath());
    }
    ...
    public Table regionZsmhcNumTable(@RequestBody TablePost tablePost) {
        ...
        return tableServer.getTable("按区域-房产税分析", tablePost, TableController.class.getResource("/table/region-zsmhc.xml").getPath());
    }
}
