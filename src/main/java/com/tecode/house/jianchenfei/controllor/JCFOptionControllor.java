 ...
 */
@Controller
public class JCFOptionControllor {
    @ResponseBody
    ...
    @ResponseBody
    @RequestMapping(value = "/single_region", method = RequestMethod.POST)
    public Option testPi() {
        ...
        ((Pie)series1).setCenter("30%", "30%").setRadius("30%");
        ...
        ((Pie)series2).setCenter("80%", "30%").setRadius("30%");
        ...
        ((Pie)series3).setCenter("30%", "60%").setRadius("30%");
        ...
        ((Pie)series4).setCenter("80%", "60%").setRadius("30%");
...
//    }
    @ResponseBody
    @RequestMapping(value = "/zsmhc_built", method= RequestMethod.POST)
