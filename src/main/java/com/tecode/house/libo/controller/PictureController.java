...
public class PictureController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/libo_room", method = RequestMethod.POST)
...
//                .addData(v1).addData(v2).addData(v3).addData(v4).addData(v5);
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/libo_single", method = RequestMethod.POST)
...
//                .addData(v1).addData(v2).addData(v3).addData(v4).addData(v5);
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/libo_self", method = RequestMethod.POST)
    public Option testPie() {
        ...
        // 数据
        MysqlDaoImpl mysqlDao = new MysqlDaoImpl();
        String sql1 = "select value from data where x='1' and legend = '自住租赁图例'";
        String sql2 = "select value from data where x != '1' and legend = '自住租赁图例'";
