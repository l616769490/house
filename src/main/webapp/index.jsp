...
<div class="container-fluid">
    ...
    <div class="row">
        <div id="btns" class="col-lg-6 col-md-offset-2">
            <button id="btn-1" class="btn btn-success" onclick="show('/city_houseDuty')">房产税</button>
            <button id="btn-2" class="btn btn-success col-md-offset-1" onclick="show('/city_singleBuilding')">独栋建筑</button>
            <button id="btn-3" class="btn btn-success col-md-offset-1" onclick="show('/basic_vacancy')">空置</button>
