...
<div class="container-fluid">
    <div class="row">
        <div id="btns" class="col-lg-8 col-md-offset-2">
            <button id="btn-1" class="btn btn-success" onclick="getTable1()">基础-房屋费用</button>
            <button id="btn-2" class="btn btn-success col-md-offset-2" onclick="getTable2()">按年龄-价格统计
            </button>
            <button id="btn-3" class="btn btn-success col-md-offset-2" onclick="getTable3()">按年龄-家庭收入
            </button>
        </div>
    </div>
