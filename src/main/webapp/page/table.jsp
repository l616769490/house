...
<div class="container-fluid">
    <div class="row">
        <div id="btns" class="col-lg-8 col-md-offset-2">
            <button id="btn-1" class="btn btn-success" onclick="getTable1()">家庭收入</button>
            <button id="btn-2" class="btn btn-success col-md-offset-2" onclick="getTable2()">家庭人数
            </button>
            <button id="btn-3" class="btn btn-success col-md-offset-2" onclick="getTable3()">市场价
            </button>
        </div>
    </div>
